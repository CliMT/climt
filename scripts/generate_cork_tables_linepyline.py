...
SCENARIOS = {
    ...
    "titan": dict(
        ...
        cia_files=[
            dict(path="climt/_data/cork/cia/N2-N2_2021.cia",
                 pair=("N2", "N2"), vmr_a=0.95, vmr_b=0.95),
            dict(path="climt/_data/cork/cia/N2-CH4_2024.cia",
    ...
    # (see docs/superpowers/plans/2026-05-16-cork-co2-band-refinement.md, exp #6).
...
_STELLAR_SPECTRA_DIR = os.path.join(
    _REPO_ROOT, "climt", "_data", "cork", "stellar_spectra"
)
