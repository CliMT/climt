...
cork component that this is a bulk-air table: per-layer optical
...
-----------
    ...
    * Chaverot tables (Zenodo 16795590, CC-BY 4.0) cover the planets / mixtures
      listed in ``regenerate_shipped_cork_tables.py``.
