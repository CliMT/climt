...
class SocratesShortwave(TendencyComponent):
    """
    Socrates shortwave radiation model wrapper.
    """
    ...
    def __init__(
        ...
        **kwargs):
        ...
        self.input_properties = SocratesShortwave.input_properties.copy()
        ...
        super(SocratesShortwave, self).__init__(**kwargs)
    ...
    def array_call(self, state):
        ...
        if self.spectrum_setter is None:
            ...
            runesobject._input_spectrum_sw(resolved_path)
        ...
        runesobject._set_fields_sw(
            ...
            *(gas_arrays + aerosol_arrays),
            ...
            np.asarray(diagnostics['downwelling_shortwave_flux_in_air']), 
            np.asarray(diagnostics['upwelling_shortwave_flux_in_air']), 
