...
class SimplePhysics(ClimtImplicit):
    ...
    def __call__(self, state, timestep):
        ...
        q_surface = get_numpy_array(state['surface_specific_humidity'].to_units('kg/kg'), ['x', 'y'])
        ...
        new_state = {
            ...
            # 'air_pressure_on_interface_levels': state['air_pressure_on_interface_levels'],
            # 'surface_air_pressure': state['surface_air_pressure'],
        }
