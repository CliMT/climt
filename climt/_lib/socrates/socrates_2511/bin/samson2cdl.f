...
! *****************************COPYRIGHT*******************************
!
!+ Program to convert a samson file to a CDL file.
!
! Purpose:
!   Reads in a Field in SAMSON format and writes it out as a CDL field.
!
! Method:
!   Straightforward.
!
...
!
     ...
     &     'enter the name of the input file.'
      ...
      CALL read_samson_p_field(ierr, file_in
...
!
!
!     Write the field out in CDL format
!
...
!     There can only be one variable in this case.
      ...
      DO i=1, n_level
        DO l=1, n_profile
          var_fl(l+(i-1)*n_profile, 1)=field(l, i)
        ENDDO
      ENDDO
!
!
