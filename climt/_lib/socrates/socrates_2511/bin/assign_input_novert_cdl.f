...
! *****************************COPYRIGHT*******************************
!
!+ Subroutine to assign a single-level field in CDL format.
!
! Purpose:
!   This subroutine reads a single CDL-file containing a field on
...
!
!- ---------------------------------------------------------------------
      SUBROUTINE assign_input_novert_cdl(ierr
