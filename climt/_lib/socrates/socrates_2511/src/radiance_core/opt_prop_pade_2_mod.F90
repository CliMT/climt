...
! *****************************COPYRIGHT*******************************
!
! Calculate optical properties for the pade_2 parametrisation
!
!------------------------------------------------------------------------------
MODULE opt_prop_pade_2_mod
...
!       Condensate mass mixing ratio
  REAL(RealK), INTENT(IN) :: radius_effect(:, id_ct:)
!       Effective radius
...
END SUBROUTINE opt_prop_pade_2
END MODULE opt_prop_pade_2_mod
