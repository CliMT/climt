...
! *****************************COPYRIGHT*******************************
!
!+ Subroutine to assign the optical properties from a netCDF-file.
!
! Purpose:
!   This subroutine reads a single netCDF-file containing a set of
...
!
!- ---------------------------------------------------------------------
      SUBROUTINE assign_input_opt_cdf(ierr
     &  , file_name
     &  , n_band
...
!     Subroutines called:
      EXTERNAL
     &     read_cdf, find_dimen_cdl, find_var_cdl
!
!
!
