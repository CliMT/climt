...
! *****************************COPYRIGHT*******************************
!
!+ Subroutine to assign a CDL field with vertical structure.
!
! Purpose:
!   This subroutine checks a single CDL field with vertical structure
...
!
!- ---------------------------------------------------------------------
      SUBROUTINE assign_input_vert_cdl(ierr
