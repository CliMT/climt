...
extinction2=np.zeros(4096*9)
ss_albedo2=np.zeros(4096*9)
asymmetry2=np.zeros(4096*9)
        ...
        if (line.find("Band") == 0):
            ...
            if (scheme == 20):
                for n in range(0, 4096):
                    ...
                    extinction2[band*4096 + n - 4096] = extinction[n]
                    ss_albedo2[band*4096 + n - 4096] = ss_albedo[n]
                    asymmetry2[band*4096 + n - 4096] = asymmetry[n]
    ...
    for line in f:
        ...
        if (line.find("Band") == 0):
            ...
            if (scheme == 20):
                ...
                for n in range(0, 4096):
                    extinction[n] = extinction2[band*4096 + n - 4096]
                    ss_albedo[n] = ss_albedo2[band*4096 + n - 4096]
                    scattering[n] = extinction[n] * ss_albedo[n]
                    asymmetry[n] = asymmetry2[band*4096 + n - 4096]
                ax[plotrow,0].plot(re*1e6, extinction,
